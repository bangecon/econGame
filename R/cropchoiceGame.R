...
cropchoiceGame <-
  function(resultsSheet,
    ...
    resultsWide$Score.1 <- ifelse(
      resultsWide$Strategy.1 == "Rice",
        ifelse(resultsWide$Strategy.2 == "Rice", payoff[1], payoff[3]),
        ifelse(resultsWide$Strategy.2 == "Cassava", payoff[4], payoff[2])
      )
    resultsWide$Score.2 <- ifelse(
      resultsWide$Strategy.1 == "Rice",
        ifelse(resultsWide$Strategy.2 == "Rice", payoff[4], payoff[3]),
        ifelse(resultsWide$Strategy.2 == "Cassava", payoff[1], payoff[2])
      )
    resultsWide$Outcome <-
